...
| B3 | Continuous monitoring / scheduled re-scans | in-progress | M | B1, D1 | — |
| B4 | Remediation workflow tracking | in-progress | M | B2, D1 | — |
| B5 | Compliance mapping + report packs | done | M | B2 | — |
| B6 | Design-partner pilot package | in-progress | S | B1–B5, H1 | — |
...
| D2 | Async job workers | done | M | D1 | — |
| D3 | Observability (tracing, logs, metrics) | not-started | M | I1 | — |
| D4 | OpenAPI + Postman collection | in-progress | S | — | — |
| D5 | Official SDKs (Python + TypeScript) | in-progress | M | D4 | — |
...
| G4 | Data governance & retention | in-progress | M | G3 | — |
| G9 | Safe logging & error responses (PHI redaction) | not-started | S | G2 | — |
| G5 | SOC 2 Type I → Type II | in-progress | L | G1–G4 | — |
...
| H5 | Self-serve PQC signup (v1) | in-progress | M | B1, H1, G4 | — |
