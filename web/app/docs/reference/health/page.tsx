...
const endpoint = docsEndpoints.health!;
...
export default function HealthReferencePage() {
  return (
    <div id={MAIN_CONTENT_ID} className="scroll-mt-24 sm:scroll-mt-28">
      <DocsJsonLd pathname="/docs/reference/health" title={endpoint.title} description={endpoint.summary} />
