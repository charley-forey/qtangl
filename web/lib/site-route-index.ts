...
export const legacyRouteRedirects: readonly LegacyRouteRedirect[] = [
  ...
  { source: "/demo", destination: "/assess", label: "Demo hub moved to Assess" },
...
const coreMarketingRoutes: SiteRouteEntry[] = [
  ...
  { href: "/demo/live", title: "Live Crypto Range", section: "Product", keywords: ["demo", "simulation", "monitor"] },
  { href: "/demo/live/status", title: "Live status wall", section: "Product", keywords: ["demo", "soc", "charts"] },
