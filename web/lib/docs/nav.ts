...
export const docsSections: DocsNavSection[] = [
  ...
  },
  {
    ...
    items: [
      { name: "Host sensor deploy", href: "/docs/guides/host-sensor-deploy", status: "pilot" },
      { name: "Code scan CI", href: "/docs/guides/code-scan-ci", status: "pilot" },
      { name: "POST /tenant/discovery/fleets", href: "/docs/reference/discovery/fleets-create", status: "pilot" },
      { name: "GET /tenant/discovery/agents", href: "/docs/reference/discovery/agents", status: "pilot" },
      { name: "POST /tenant/coverage/code-scan", href: "/docs/reference/discovery/code-scan", status: "pilot" },
      { name: "POST /tenant/discovery/binary-scan", href: "/docs/reference/discovery/binary-scan", status: "pilot" },
      { name: "GET /tenant/discovery/jobs/{job_id}", href: "/docs/reference/discovery/jobs", status: "pilot" },
    ],
  },
  {
    id: "integrations",
