...
import { platformExtendedEndpoints } from "@/lib/docs/endpoints/platform-extended";
...
const coreDocsEndpoints: Record<string, DocsEndpoint> = {
  ...
  "pqc-report": {
    ...
    queryParams: [
      {
        ...
        required: false,
        default: "json",
        description: "json|csv|cbom|pdf|bundle|executive|board|auditor",
      },
    ],
    formatMatrix: [
      { name: "json", type: "application/json", description: "Structured report payload." },
      { name: "csv", type: "text/csv", description: "Tabular findings export." },
      { name: "cbom", type: "application/json", description: "CycloneDX CBOM export." },
    ...
    notes: [
      "Same format matrix as GET /tenant/scans/{scan_id}/report for tenant-persisted scans.",
      "Use GET /pqc/report/{scan_id}/availability to check which formats are ready.",
    ],
  },
  "pqc-transparency": {
    id: "pqc-transparency",
