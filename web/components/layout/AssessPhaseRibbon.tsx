...
import { assessPhaseRibbonItems } from "@/lib/copy/assess-phase-ribbon";
    ...
    >
      <div className="mx-auto w-full max-w-[var(--container-wide)] px-[var(--gutter-mobile)] py-3 sm:px-[var(--gutter-tablet)] lg:px-[var(--gutter-desktop)]">
        ...
        <nav aria-label="Assess page sections">
          <ul className="tech-scroll-fade flex gap-2 overflow-x-auto pb-1 md:flex-wrap md:gap-3">
            {assessPhaseRibbonItems.map((item) => {
